...
+ (void)drawIconForRef:(IconRef)ref inRect:(NSRect)rect label:(int)label selected:(BOOL)selected flip:(BOOL)flip;
+ (void)drawIconForRef:(IconRef)ref inRect:(NSRect)rect label:(int)label selected:(BOOL)selected flip:(BOOL)flip alpha:(float)alpha;
